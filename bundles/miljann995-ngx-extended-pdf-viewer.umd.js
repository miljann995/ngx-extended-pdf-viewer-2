(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/forms'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@miljann995/ngx-extended-pdf-viewer', ['exports', 'rxjs', '@angular/forms', '@angular/common', '@angular/core'], factory) :
    (factory((global.miljann995 = global.miljann995 || {}, global.miljann995['ngx-extended-pdf-viewer'] = {}),global.rxjs,global.ng.forms,global.ng.common,global.ng.core));
}(this, (function (exports,rxjs,forms,common,i0) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.pdfDefaultOptions = {
        ...
        cMapUrl: ( /**
         * @return {?}
         */function () { return './' + exports.pdfDefaultOptions.assetsFolder + '/cmaps/'; }),
    ...
    if ((( /** @type {?} */(window))).pdfDefaultOptions) {
        exports.pdfDefaultOptions = (( /** @type {?} */(window))).pdfDefaultOptions;
    }
    else {
        (( /** @type {?} */(window))).pdfDefaultOptions = exports.pdfDefaultOptions;
    }
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
                    ...
                    if (!window['pdfjs-dist/build/pdf']) {
                        ...
                        if (this.minifiedJSLibraries) {
                            if (!exports.pdfDefaultOptions.workerSrc().endsWith('.min.js')) {
                                ...
                                exports.pdfDefaultOptions.workerSrc = ( /**
                                 * @return {?}
         ...
         */
            function () {
                ...
                for (var key in exports.pdfDefaultOptions) {
         ...
         */
            function (object1, object2) {
                ...
                try {
                    ...
                    try {
                        if (keys1_1_1 && !keys1_1_1.done && (_a = keys1_1.return))
                            _a.call(keys1_1);
                    }
                    finally {
                        if (e_1)
                ...
                try {
                    ...
                    try {
                        if (keys2_1_1 && !keys2_1_1.done && (_b = keys2_1.return))
                            _b.call(keys2_1);
                    }
                    finally {
                        if (e_2)
        ...
        */
        ...
        NgxExtendedPdfViewerComponent.propDecorators = {
            ...
            customSidebar: [{ type: i0.Input }],
            customThumbnail: [{ type: i0.Input }],
            customFreeFloatingBar: [{ type: i0.Input }],
            formData: [{ type: i0.Input }],
            formDataChange: [{ type: i0.Output }],
            pageViewMode: [{ type: i0.Input }],
            secondaryToolbarComponent: [{ type: i0.ViewChild, args: ['pdfSecondaryToolbarComponent',] }],
            sidebarComponent: [{ type: i0.ViewChild, args: ['pdfsidebar',] }],
            srcChange: [{ type: i0.Output }],
            scrollMode: [{ type: i0.Input }],
            scrollModeChange: [{ type: i0.Output }],
            authorization: [{ type: i0.Input }],
            httpHeaders: [{ type: i0.Input }],
            ...
            localeFolderPath: [{ type: i0.Input }],
    ...
    var PdfRotatePageComponent = /** @class */ (function () {
        ...
        PdfRotatePageComponent.propDecorators = {
            ...
            counterClockwise: [{ type: i0.Input }],
    ...
    var PdfSidebarComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfSidebarComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
    ...
    var PdfZoomDropdownComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfZoomDropdownComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var PdfSidebarContentComponent = /** @class */ (function () {
        ...
        PdfSidebarContentComponent.propDecorators = {
            customThumbnail: [{ type: i0.Input }],
            thumbnailViewTemplate: [{ type: i0.ViewChild, args: ['thumbnailViewTemplate',] }],
            thumbnailDrawn: [{ type: i0.Output }],
            hideSidebarToolbar: [{ type: i0.Input }]
        };
    ...
    exports.ScrollModeType = ScrollModeType;
    ...
    exports.ɵf = PdfDarkThemeComponent;
    exports.ɵg = PdfLightThemeComponent;
    exports.ɵe = PdfOriginalComponent;
    exports.ɵc = PdfFindbarService;
    exports.ɵd = PdfPageNumberComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=miljann995-ngx-extended-pdf-viewer.umd.js.map